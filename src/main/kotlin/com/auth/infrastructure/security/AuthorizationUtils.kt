...
class AuthorizationUtils {
    ...
    fun hasAnyPermission(authentication: Authentication, permissions: List<String>): Boolean {
        return authentication.authorities.any { authority -> 
            permissions.any { permission -> authority.authority == permission }
        }
    }
    
    fun hasAllPermissions(authentication: Authentication, permissions: List<String>): Boolean {
