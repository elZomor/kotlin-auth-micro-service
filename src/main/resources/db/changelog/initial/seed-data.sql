...
VALUES (gen_random_uuid(), 'user.read', now(), now()),
       (gen_random_uuid(), 'user.write', now(), now()),
       (gen_random_uuid(), 'role.read', now(), now()),
       (gen_random_uuid(), 'role.write', now(), now());

--changeset zomor-roles:1-1
INSERT INTO roles (id, name, created_at, updated_at)
VALUES (gen_random_uuid(), 'ROLE_ADMIN', now(), now()),
