...
import com.auth.presentation.dto.UserResponse
...
object TestDataFactory {
    ...
    fun createRefreshTokenRequest(refreshToken: String = "refresh-token") = RefreshTokenRequest(refreshToken = refreshToken)

    fun createUpdateUsernameRequest(username: String = "newusername") = UpdateUsernameRequest(username = username)

    fun createCreateRoleRequest(name: String = "ADMIN") = CreateRoleRequest(name = name)

    fun createCreatePermissionRequest(name: String = "WRITE_USER") = CreatePermissionRequest(name = name)
